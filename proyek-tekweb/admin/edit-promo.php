...
if (isset($_POST['edit'])) {
    ...
    if ($admin->get_id_promo($id)) {
        $update_data = $admin->update_promo([
            'id' => $id,
            'nama' => $nama,
            'deskripsi' => $deskripsi,
            'potongan' => $potongan,
        ...
        if ($update_data) {
            $msg = 'Berhasil mengedit data promo.';
            header("Location: ../admin/table-promo.php");
            exit();
        } else {
            $msg = 'Gagal mengedit data promo.';
        }
    } else {
        $msg = 'Gagal mengedit data promo.';
    }
        ...
        * {
        ...
        .main {
            ...
            background-image: linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)),
                url("asset-admin/allproduct-table-background.jpg");
