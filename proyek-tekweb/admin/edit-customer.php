...
if (isset($_POST['edit'])) {
    ...
    if ($admin->get_id_username($id)) {
        $update_data = $admin->update_user([
            'id' => $id,
            'username' => $username,
            'alamat' => $alamat,
            'notelp' => $notelp,
        ...
        if ($update_data) {
            $msg = 'Berhasil mengedit data customer.';
            header("Location: ../admin/table-customer.php");
            exit();
            $msg = 'Gagal mengedit data customer';
        }
    }
}
        ...
        <div class="container">
            <form action="#" method="post">
                ...
                <div class="d-grid gap-2">
                    <a href="table-customer.php" class="btn btn-danger">&laquo; Cancel</a>
