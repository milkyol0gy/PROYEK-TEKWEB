    ...
    $customers = $admin->search_user($searchTerm)->fetchAll(PDO::FETCH_ASSOC);

    if (isset($_GET['id']) && count($_GET)) {
        $delete_data = $admin->delete_user($_GET['id']);
            ...
            <nav class="navbar-bg">
                <div class="navbar">
                    <ul class="navbar-list">
                        ...
                        <li><a href="#" id="custtable">Customer Table</a></li>
                ...
                <div class="table-title">
                    <form class="search-form" method="get">
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="Search by customer name" name="search" value="<?= htmlspecialchars($searchTerm) ?>">
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="edit-customer.php?id=<?= $data['id'] ?>" class="btn btn-primary btn-sm">Edit</a>
                                        <form method="post" action="" id="deleteForm<?= $data['id'] ?>" style="display: inline;">
                                            <input type="hidden" name="id" value="<?= $data['id'] ?>">
                                            <a href="table-customer.php?id=<?= $data['id'] ?>" class="btn btn-danger btn-sm btn-delete" onclick="confirmDelete(<?= $data['id'] ?>, event)">delete</a>
                                        </form>
                                    </td>
                                </tr>
                        <?php
