...
<body>
    ...
    <div class="container" style="margin-top: 30px;">
    	...
    	<div class="card">
    		<div class="card-header" id="name-product">Sample Product</div>
    		<div class="card-body">
    			<div class="row">
            ...
            success:function(data)
            {
                ...
                if(data.review_data.length > 0)
                {
                    ...
                    for(var count = 0; count < data.review_data.length; count++)
                    {
                        ...
                        html += '<div class="col-sm-1"><div class="rounded-circle bg-primary text-white pt-2 pb-2"><h3 class="text-center" id="icon">'+data.review_data[count].user_name.charAt(0)+'</h3></div></div>';

                        html += '<div class="col-sm-11">';

                        html += '<div class="card">';

                        html += '<div class="card-header" id="comment"><b>'+data.review_data[count].user_name+'</b></div>';
                        ...
                        html += '<div class="card-footer text-right" id="comment-2">On '+data.review_data[count].datetime+'</div>';
