  ...
  <body>
    <div class="sign-in">
      <form action="sign-in.php" method="post">
        <img class="sign-in-child" alt="" src="sign-in/rectangle-1@2x.png" />
        <img
          class="logo-bli-n-go-2-1"
          alt=""
          src="sign-in/logo-bli-n-go-2-1@2x.png"
        />
...
if (isset($_POST['signin'])) {
  ...
  $check_user = User::check_User($uname, $pass);
  $check_admin = Admin::check_Admin1($uname, $pass);

  if ($check_user > 0) {
      $_SESSION['uname'] = $uname;
      $_SESSION['user_id'] = User::getId($uname);
