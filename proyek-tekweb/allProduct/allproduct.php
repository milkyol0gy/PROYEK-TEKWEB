<?php
    ...
    $userData = $user->search_barang($searchTerm)->fetchAll(PDO::FETCH_ASSOC);
?>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="mynavbar">
            <ul class="navbar-nav me-auto">
              <li class="nav-item">
                <a class="nav-link" href="#" id="allproduct">All Product</a>
              </li>
            </ul>
            <div class="d-flex">
                <ul class="navbar-nav me-auto">
        ...
        <form action="./search.php" method="POST">
            <div class="input-group rounded">
                <span class="input-group-text border-0" id="search-addon">
                    <img src="./asset-allproduct/search.png" alt="search" style="height: 30px;">
                </span>
                <input type="text" class="form-control" style="text-align: center;" placeholder="Search Item" name="search" value="<?= htmlspecialchars($searchTerm) ?>">
